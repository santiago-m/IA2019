...
manhattan_iterations = 20
misplaced_iterations = 20
gaschnig_iterations = 20
max_man_gasch_iterations = 20
''' ------------------------------------------------------------------------------------- '''
...
def test_manhattan_heuristic(state):
	...
	init = time.time()
	solution = astar_search(puzzle, NPuzzleHeuristics(aux_size).manhattan).solution()
	end = time.time()
	length = len(solution)
...
def test_misplaced_tiles_heuristic(state):
	...
	init = time.time()
	solution = astar_search(puzzle, NPuzzleHeuristics(aux_size).misplaced_tiles).solution()
	end = time.time()
	length = len(solution)
...
def test_gaschnig_heuristic(state):
	...
	init = time.time()
	solution = astar_search(puzzle, NPuzzleHeuristics(aux_size).gaschnig).solution()
	end = time.time()
	length = len(solution)
...
def test_max_manhattan_gaschnig_heuristic(state):
	...
	init = time.time()
	solution = astar_search(puzzle, NPuzzleHeuristics(aux_size).max_manhattan_gaschnig).solution()
	end = time.time()
	length = len(solution)
